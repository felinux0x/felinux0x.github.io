  ...
  return (
    <header className={`p-4 transition-all duration-300 ${scrolled ? "border-b-2 border-white/50 shadow-lg" : "border-b border-white/30"}`}>
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <nav>
          <ul className="flex space-x-6 text-sm flex-wrap justify-center gap-y-2">
            <li>
            ...
            <li>
              <Link href="/tips" className="hover:text-gray-400 transition-colors">
                TIPS
              </Link>
            </li>
            <li>
              <Link href="/achievements" className="hover:text-gray-400 transition-colors">
                ACHIEVEMENTS
              </Link>
            </li>
            <li>
